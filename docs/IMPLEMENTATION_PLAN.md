...
| --- | --- |
| 当前版本 | `0.1.0` |
| 当前阶段 | T326 菜单栏仅显示周额度环与百分比已完成；等待用户重新打包安装确认菜单栏效果 |
